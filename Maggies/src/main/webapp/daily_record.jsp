                ...
                <div class="col-md-12">
                    ...
                    <form style="margin-top:50px;" action="patient_merge.do" method="post">
                        <table class="table table-striped">
                            ...
                            <s:iterator value="record_list" id="record">
                                <tr>
                                    <input type="hidden" name="original_day_ids" value="<s:property value="day_id"/>" />
                                    <td><input type="text" name="day_ids" value="<s:property value="day_id"/>" size="2"/></td>
